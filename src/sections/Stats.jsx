        ...
        <div className="relative mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((item, index) => (
            ...
            >
              ...
              <h3 className="mt-5 font-display text-lg font-extrabold leading-7 text-somcit-navy">{t.stats.items[index].title}</h3>
              <p className="mt-3 leading-7 text-slate-600">{t.stats.items[index].description}</p>
            </motion.div>
          ))}
        </div>
      </Container>

...
import { processPoints } from '../data/siteData.js';
  ...
  return (
    <section id="about" className="scroll-mt-24 bg-white py-28 sm:py-36">
      <Container className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <SectionHeader
          align="left"
          eyebrow="About SOMACIT"
          title="A practical digital partner for systems that matter."
          description="We combine software engineering, product thinking, and visual design to create dependable tools for schools, retailers, suppliers, and service companies."
        />
        <motion.div
